...
Username:<br />
<input type="text" name="username_login" size="20" class="input_box_style" value="<?php=$username=?>;" />
<br />
Password:<br />
<input type="password" name="password_login" size="20" class="input_box_style" value="<?php=$password=?>;" />
<br />
<input type="submit" value="Sign In!" name="login" id="login" class="submit_button_style" />
<input type="hidden" name="a" value="login2" />
<input type="hidden" name="return_url" value="<?php=$return_url?>;" />
</form>
